  ...
  export default {
    ...
    methods: {
      ...
      loadModel(callback) {
        ...
        // 加载NPC模型
        loader.load('models/walk/npc.glb', async (obj) => {

          console.log('加载模型回调', obj)
          ...
          // 添加角色的光环贴图
        //   const ringTex = await new Three.TextureLoader().loadAsync(require('@/assets/textures/role-ring.png'));
      ...
      async renderPath() {
        ...
        // 金色箭头的png作为材质
        const arrow = await new Three.TextureLoader().loadAsync(require('@/assets/arrowhead.png'));
